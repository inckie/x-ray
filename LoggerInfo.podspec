...
Pod::Spec.new do |s|
  ...
  s.resources = [
    'apple/Extensions/LoggerNavigationController/**/*.xib',
    'apple/Extensions/LoggerNavigationController/**/*.png'
  ]
  s.source_files = 'apple/Extensions/LoggerNavigationController/**/*.{swift}'
